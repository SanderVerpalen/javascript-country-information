...
async function fetchCountries() {
    try {
        ...
        countryList.innerHTML = response.data.map((c)=>getCountry(c)
        ).join('');
        ...
        if (e.response.status === 500) errorMessage.textContent = "Er ging iets mis bij de server.";
...
//# sourceMappingURL=countrySearcher.0641b553.js.map
