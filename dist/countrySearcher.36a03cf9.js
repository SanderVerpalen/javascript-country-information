...
})({"50kZY":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
async function fetchCountry(input) {
    try {
        const response = await _axiosDefault.default.get('https://restcountries.com/v2/name/' + input);
        displayCountry(response);
    } catch (e) {
        // Catch errors.
        console.error(e);
        console.log(e.response);
        if (e.response.status === 500) textElement.textContent = "Er ging iets mis bij de server.";
        else if (e.response.status === 404) textElement.textContent = "Het verzoek is mislukt.";
    }
}
function currencies(country) {
    ...
    else return `${country.data[0].currencies[0].name}'s`;
}
...
},{}]},["50kZY","1RMZw"], "1RMZw", "parcelRequirecb08")

//# sourceMappingURL=countrySearcher.36a03cf9.js.map
